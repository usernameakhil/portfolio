  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Hi, I’m <strong>Akhil</strong> — an aspiring{" "}
          <strong>Artificial Intelligence Engineer</strong> {" "}
          <strong>Machine Learning enthusiast</strong>and{" "}
          <strong>FullStack Developer</strong> who loves turning ideas
        ...
        <p>
            2nd-year B.Tech AIML student with hands-on experience in FullStack,ML & DL Projects. Proficient in Web Development,Python, scikitlearn,pytorch,tensorflow and data preprocessing. Seeking internship opportunities to apply skills and contribute to
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>NITKKR (National Institute of Technology Kurukshetra)</strong> — Kurukshetra,
                  Haryana
                </p>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>Bhashyam Institute</strong> — Guntur, Andhra Pradesh
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  AP Board | Percentage: 90%
                </p>
            ...
            >
              ...
              <div>
                ...
                >
                  <strong>Bhashyam Institute</strong> — Guntur,
                  Andhra Pradesh
                </p>
                <p style={{ color: "rgba(255,255,255,0.7)" }}>
                  Ap Board | Percentage: 92%
                </p>
