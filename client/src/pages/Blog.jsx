...
export default function Blog() {
  const defaultPosts = [
    {
      ...
      text: "Working on AI-based systems  has taught me how impactful technology can be when applied on Real Life Problems. Combining deep learning with real-world problems is my favorite way to innovate.",
    },
    {
      id: 2,
  ...
  useEffect(() => {
    ...
    const votedByUser = JSON.parse(localStorage.getItem("blog_voted") || "{}");
